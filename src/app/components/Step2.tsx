...
export default function Step2({ value, setValue }: { value: number; setValue: (v: number) => void }) {
            ...
            <div className="mb-17 flex flex-col bg-[#f9f9f9] rounded-3xl w-240 h-80">
                ...
                <div className="flex flex-col items-center justify-center">
                    <p className="mt-2 leading-tight text-center pl-65 pr-65 text-lg text-black">
                        ...
                        <span className="font-bold"> Does your field have a slope less than/equal to 3%?</span>
