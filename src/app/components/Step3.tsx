...
export default function Step3({value, setValue}: { value: number; setValue: (v: number) => void }) {
  ...
  return (
      ...
      <div className="mb-17 flex flex-col bg-[#f9f9f9] rounded-3xl w-240 h-90">
        ...
        <div className="flex items-center gap-22 mb-4 ">
          <div
              className="w-8 h-8 mt-10 ml-10 rounded-full bg-[#577bb5] text-white flex items-center justify-center font-bold text-lg">
            3
          </div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="mt-4 leading-tight text-center pl-50 pr-50 text-lg text-black">
            Determine whether your soil falls into <span className="font-bold">Moderately Sandy Soils</span> or <span
              className="font-bold">Predominantly Sandy Soils</span>.
          </p>

          <div className="flex mt-6 gap-4">
            <button
                className={`px-6 py-2 rounded-lg font-bold text-lg text-[#275c9d] ${value === 3 ? 'bg-blue-200 border-2 border-blue-500' : 'bg-gray-200'}`}
                onClick={() => setValue(3)}
                type="button"
            >Hydrologic Group A
            </button>
          ...
          <p className="mt-4 leading-tight text-center pl-50 pr-50 text-lg text-black">
            If you are unsure about your soil group, visit the <span className="font-bold">USDA’s Web Soil Texture Survey Tool</span> and
            begin a soil survey.
          </p>
        </div>
      </div>
