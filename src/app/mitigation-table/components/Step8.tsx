...
export default function Step8({ value, setValue }: { value: string; setValue: (v: string) => void }) {
  const arr = typeof value === "string" ? value.split("-").map(Number) : [0, 0, 0, 0, 0, 0, 0, 0, 0];
  ...
  function handleAnswer(questionId: string, newPoints: number) {
    ...
    setValue(`${newAnswers.q1}-${newAnswers.q2}-${newAnswers.q3}-${newAnswers.q4}-${newAnswers.q5}-${newAnswers.q6}-${newAnswers.q7}-${newAnswers.q8}-${newAnswers.q9}`);
  }
    ...
    <div className="bg-[#f9f9f9] rounded-3xl p-10 my-18">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center m-4">
          ...
          <div className="">
            <div className="flex gap-4">
              <button
                className={`cursor-pointer px-6 py-2 rounded-lg font-bold text-lg text-[#275c9d] ${answers["q1"] === 3
        ...
        <div className="flex flex-col items-center m-4">
          ...
          <div className="flex gap-4">
            <button
              className={`cursor-pointer px-6 py-2 rounded-lg font-bold text-lg text-[#275c9d] ${answers["q3"] === 2
                ? "bg-blue-200 border-2 border-blue-500"
                : "bg-gray-200"
                }`}
        ...
        <div className="flex flex-col items-center m-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              className={`cursor-pointer px-6 py-2 rounded-lg font-bold text-lg text-[#275c9d] ${answers["q4"] === 0
                ? "bg-blue-200 border-2 border-blue-500"
                : "bg-gray-200"
                }`}
        ...
        <div className="flex flex-col items-center m-4">
          ...
          <div className="flex gap-4">
            <button
              className={`cursor-pointer px-6 py-2 rounded-lg font-bold text-lg text-[#275c9d] ${answers["q5"] === 2
                ? "bg-blue-200 border-2 border-blue-500"
                : "bg-gray-200"
                }`}
        ...
        <div className="flex flex-col items-center m-4">
          ...
          <div
            className={`mx-15 mb-5 cursor-pointer flex flex-col items-center rounded-xl bg-[#577bb5] ${answers["q7"] === 2 ? "border-2 border-blue-500" : ""
              }`}
          ...
          >
            ...
            <div
              className={`flex items-center p-6 rounded-b-xl ${answers["q7"] === 2 ? "bg-blue-200" : "bg-gray-200"
                }`}
            >
          ...
          <div
            className={`mx-15 cursor-pointer flex flex-col items-center rounded-xl bg-[#577bb5] ${answers["q7"] === 3 ? "border-2 border-blue-500" : ""
              }`}
            onClick={() => handleAnswer("q7", 3)}
          >
            <p className="p-3 text-lg text-white font-bold">No irrigation</p>
            <div
              className={`flex items-center p-6 rounded-b-xl ${answers["q7"] === 3 ? "bg-blue-200" : "bg-gray-200"
                }`}
            >
              <p className="font-medium text-lg text-[#275c9d]">
        ...
        <div className="flex flex-col items-center m-4">
          ...
          <div className="flex gap-4">
            <button
              className={`cursor-pointer px-6 py-2 rounded-lg font-bold text-lg text-[#275c9d] ${answers["q8"] === 1
                ? "bg-blue-200 border-2 border-blue-500"
                : "bg-gray-200"
                }`}
            ...
            <button
              className={`cursor-pointer px-6 py-2 rounded-lg font-bold text-lg text-[#275c9d] ${answers["q8"] === 3
                ? "bg-blue-200 border-2 border-blue-500"
                : "bg-gray-200"
                }`}
        ...
        <div className="flex flex-col items-center m-4">
          ...
          <div className="flex gap-4">
            <button
              className={`cursor-pointer px-6 py-2 rounded-lg font-bold text-lg text-[#275c9d] ${answers["q9"] === 2
                ? "bg-blue-200 border-2 border-blue-500"
                : "bg-gray-200"
                }`}
            ...
            <button
              className={`cursor-pointer px-6 py-2 rounded-lg font-bold text-lg text-[#275c9d] ${answers["q9"] === 0
                ? "bg-blue-200 border-2 border-blue-500"
                : "bg-gray-200"
                }`}
      ...
      <div className="mt-10">[8] Points: {currentPoints}</div>
    </div>
  );
}
