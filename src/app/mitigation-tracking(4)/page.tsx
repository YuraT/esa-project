...
export default function MitigationTracking() {
    ...
    return (
        <div className="flex flex-col bg-white min-h-screen"> 
            <div className="flex flex-col bg-[#f9f9f9] rounded-3xl w-150 h-150">
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="flex">
                        <div 
                            ...
                            } font-bold text-xl flex items-center justify-center mt-6 h-14 w-25 rounded-l-3xl border-l-4 border-t-4 border-b-4 border-t-[#cee0f5] border-b-[#cee0f5] border-l-[#cee0f5]`}
                        >
                            YES
                        </div>
                        <div 
                            ...
                            className={`${
                                selected === "yes" ? "bg-[#cee0f5] text-[#275c9d]" : "bg-white text-[#275c9d] hover:bg-[#cee0f5] cursor-pointer"
                            } font-bold text-xl flex items-center justify-center mt-6 h-14 w-25 rounded-r-3xl border-r-4 border-t-4 border-b-4 border-t-[#cee0f5] border-b-[#cee0f5] border-r-[#cee0f5] border-l-4 border-l-[#cee0f5]`}
                        >
                            NO
                        </div>
                    </div>
